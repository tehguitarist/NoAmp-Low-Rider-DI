...
public:
    ...
    void paint(juce::Graphics& g) override
    {
        ...
        for (int i = 0; i < N; ++i)
        {
            ...
            juce::uint32 col;
            if (frac > 0.86f)
                col = lit ? PedalLookAndFeel::cMeterHigh : PedalLookAndFeel::cMeterHighDim;
            else if (frac > 0.65f)
                col = lit ? PedalLookAndFeel::cMeterMid : PedalLookAndFeel::cMeterMidDim;
            else
                col = lit ? PedalLookAndFeel::cMeterLow : PedalLookAndFeel::cMeterLowDim;
